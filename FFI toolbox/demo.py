...
#mappe: Mappen med bildene som skal bli analysert
#mappe = "/home/sommerstudent/py-faster-rcnn/data/demo"
mappe = "/home/sommerstudent/testdata/10m"
...
if __name__ == '__main__':
    ...
    caffemodel = os.path.join(cfg.DATA_DIR, 'faster_rcnn_models', # 'faster_rcnn_models',
    ...
    im_names = os.listdir(mappe)
    i = 0
    for im_name in im_names:
        print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
        print 'Demo for {}'.format(os.path.join(mappe, im_name))
        demo(net, mappe, im_name)
        if i >= 10: # i >= n: Analyser kun n bilder
            break
        i += 1
